...
```bash
wget https://github.com/messense/aliyundrive-webdav/releases/download/v1.2.2/aliyundrive-webdav_1.2.2_aarch64_generic.ipk
wget https://github.com/messense/aliyundrive-webdav/releases/download/v1.2.2/luci-app-aliyundrive-webdav_1.2.2_all.ipk
wget https://github.com/messense/aliyundrive-webdav/releases/download/v1.2.2/luci-i18n-aliyundrive-webdav-zh-cn_1.2.2-1_all.ipk
opkg install aliyundrive-webdav_1.2.2_aarch64_generic.ipk
opkg install luci-app-aliyundrive-webdav_1.2.2_all.ipk
opkg install luci-i18n-aliyundrive-webdav-zh-cn_1.2.2-1_all.ipk
```
