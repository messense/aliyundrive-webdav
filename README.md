...
```bash
wget https://github.com/messense/aliyundrive-webdav/releases/download/v0.3.1/aliyundrive-webdav_0.3.1-1_aarch64_generic.ipk
wget https://github.com/messense/aliyundrive-webdav/releases/download/v0.3.1/luci-app-aliyundrive-webdav_0.3.1_all.ipk
wget https://github.com/messense/aliyundrive-webdav/releases/download/v0.3.1/luci-i18n-aliyundrive-webdav-zh-cn_0.3.1-1_all.ipk
opkg install aliyundrive-webdav_0.3.1-1_aarch64_generic.ipk
opkg install luci-app-aliyundrive-webdav_0.3.1_all.ipk
opkg install luci-i18n-aliyundrive-webdav-zh-cn_0.3.1-1_all.ipk
```
